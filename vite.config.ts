  ...
  build: {
    ...
    lib: {
      ...
      fileName: (format, entryName) =>
        entryName + (format === "es" ? ".js" : `.${format}.js`), // File names for the output files
    },
    rollupOptions: {
      ...
      input: {
        ...
        BlinkBlink: resolve(
          __dirname,
          "src/lib/components/BlinkBlink/index.tsx"
        ),
        Pikachu: resolve(__dirname, "src/lib/components/Pikachu/index.tsx"),
        ErrorBoundary: resolve(
          __dirname,
          "src/lib/components/ErrorBoundary/index.tsx"
        ),
